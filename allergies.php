...
$query="insert into allergies(username,eczema,hives,warts,eggs,milk,treenut,fish,wheat,soy,peanut,penicillin,antibiotics,antiinflammatory,chemotherapy) VALUES ('$username','$eczema','$hives','$warts','$eggs','$milk','$treenut','$fish','$wheat','$soy','$peanut','$penicillin','$antibiotics','$antiinflammatory','$chemotherapy')";
mysqli_query($q,$query) or die(mysqli_error($q));
$_SESSION['user_id']=$name;
mysqli_close($q);
header('Location: symptoms.html');
}
else{
